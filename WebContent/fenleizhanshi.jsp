                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items" style="background:#0099FF;">
                            <%for(String fenlei:list)
                            	...
                            	%>
                            	<li class="nav-item">
                                <a style="color:#FFFFFF;" href="fenleizhanshi.jsp?fenlei=<%=fenlei %>" class="nav-link<%if(name.equals(fenlei)){out.print(" active");} %>">
            ...
            <div class="container-fluid">
				<div align="center" class="table-b">
					...
					if(!cilist.isEmpty())
					{
						...
						out.print("<tr><td>热词</td><td>解释</td><td>分类</td><td>百度百科</td><td>查重标红</td><td>重复率</td></tr>");
						for(reci a:cilist)
						{
							out.print("<tr>");
